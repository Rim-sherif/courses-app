...
export default function CourseCard({ course, stars, customWidth }) {
  ...
  return (
    <div
      className={`${
        customWidth == 4 ? "lg:w-[24%]" : "lg:w-[32.5%]"
      } relative w-[100%] sm:w-[48%] border-1 rounded border-gray-200 p-5 mb-3 text-center
    `}
    >
      ...
      <div className="mb-3">
        <img src={course?.url} className="w-full h-50 mx-auto" alt="" />
      </div>
