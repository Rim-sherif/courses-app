      ...
      {({ active }) => (
        ...
        >
          ...
          <div className="ml-3 truncate">
            ...
            <span className="text-sm text-gray-500 truncate">Hey! Just wanted to check in...</span>
          </div>
        </a>
      )}
    </Menu.Item>
    <Menu.Item>
      {({ active }) => (
        ...
        >
          ...
          <div className="ml-3 truncate">
            <h4 className="text-sm font-medium text-gray-900">Mike Chen</h4>
            <span className="text-sm text-gray-500 truncate">About tomorrow's meeting...</span>
          </div>
        </a>
      )}
    </Menu.Item>
